				...
				<View style={[styles.modalWarp, this.props.styles.modalWarp]}>
					<KeyboardAvoidingView
						...
						style={[
							...
							this.props.styles.keyboardStyle,
						]}
					>
						<View
							style={[styles.contentWarp, this.props.styles.contentWarp]}
						>
							<WebView
...
const defaultProps = {
	redirectUrl: "https://guardioes.cria.org.br",
	styles: {},
